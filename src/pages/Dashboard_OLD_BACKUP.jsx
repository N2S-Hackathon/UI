...
function Dashboard() {
  ...
  const cohorts = COHORTS_DATA;
  const promotions = PROMOTIONS_DATA;
  ...
  // Memoize date options to prevent recalculation
  ...
  const handleQuickEndDateSelect = (dateValue) => {
                ...
                <div className="create-conversation">
                  <div className="modal-messages">
                    {createMessages.map((message) => {
                      ...
                      let cleanContent = message.content.replace('[SHOW_PRODUCTS]', '').replace('[SHOW_COHORTS]', '').replace('[SHOW_DATE_PICKER]', '').replace('[SHOW_END_DATE_PICKER]', '');
                            ...
                            <div className="date-selection-panel">
                              ...
                              <div className="custom-date-section">
                                ...
                                >
                                  ...
                                  {showCustomDatePicker ? 'Hide calendar' : 'Pick custom date'}
                                </button>
                          ...
                          {showEndDatePicker && !newPromotion.endDate && (
                            <div className="date-selection-panel">
                              <div className="quick-date-buttons">
                                {quickDateOptions.map(option => (
                                  <button
                                    ...
                                    onClick={() => handleQuickEndDateSelect(option.value)}
                                  >
                                    <div className="date-button-content">
                                      <span className="date-label">{option.label}</span>
                                      <span className="date-value">{option.date}</span>
                              ...
                              <div className="custom-date-section">
                                <button 
                                  className="custom-date-toggle"
                                  onClick={() => setShowCustomEndDatePicker(!showCustomEndDatePicker)}
                                >
                                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                                    <line x1="16" y1="2" x2="16" y2="6"></line>
                                  ...
                                  {showCustomEndDatePicker ? 'Hide calendar' : 'Pick custom date'}
                                </button>
